...
@section('title', 'Tools ElevenLabs')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <a
                href="{{ route('elevenlabs.tools.create') }}"
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors duration-200">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center space-x-2 ml-4">
                                <form
                                    action="{{ route('elevenlabs.tools.toggle-active', $tool) }}"
                                    method="POST"
                                    class="inline"
                                >
                                    @csrf
                                ...
                                <a
                                    href="{{ route('elevenlabs.tools.edit', $tool) }}"
                                ...
                                <form
                                    action="{{ route('elevenlabs.tools.destroy', $tool) }}"
                                    method="POST"
                                    class="inline"
