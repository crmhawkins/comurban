...
@section('title', 'Crear Cuenta de Correo')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Configura una nueva cuenta de correo para enviar emails desde las tools</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow border border-gray-200 p-6">
        <form method="POST" action="{{ route('email-accounts.store') }}">
            ...
            <div class="mb-6">
                ...
                >
                    <option value="smtp" {{ old('mailer', 'smtp') === 'smtp' ? 'selected' : '' }}>SMTP</option>
            ...
            <div id="smtp-config" style="display: {{ old('mailer', 'smtp') === 'smtp' ? 'block' : 'none' }};">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        >
                            ...
                            <option value="null" {{ old('encryption') === 'null' ? 'selected' : '' }}>Sin encriptación</option>
                        </select>
                        @error('encryption')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
