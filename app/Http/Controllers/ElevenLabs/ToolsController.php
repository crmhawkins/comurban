...
class ToolsController extends Controller
{
    ...
    {
        $tools = WhatsAppTool::forPlatform('elevenlabs')->ordered()->paginate(20);

        return view('elevenlabs.tools.index', [
            'tools' => $tools,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('elevenlabs.tools.create', [
    ...
    public function store(Request $request)
    {
        ...
        // Forzar plataforma a elevenlabs o both si se selecciona both
        $platform = $request->input('platform', 'elevenlabs');
        if ($platform === 'whatsapp') {
            $platform = 'elevenlabs'; // No permitir solo whatsapp en este controlador
        }
        ...
        return redirect()->route('elevenlabs.tools.index')
    ...
    {
        return view('elevenlabs.tools.show', [
            'tool' => $tool,
        ]);
    }
    ...
    public function edit(WhatsAppTool $tool)
    {
        ...
        return view('elevenlabs.tools.edit', [
            'tool' => $tool,
            'predefinedTypes' => $predefinedTypes,
            'templates' => $templates,
        ]);
